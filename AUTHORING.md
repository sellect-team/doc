...
>
> **조직별 디자인**: 이 문서의 규격(16:9 캔버스·메타·파일명·자체 완결)은 모든 조직 공통입니다.
> 다만 색·폰트·슬라이드 마스터는 조직마다 다릅니다. `docs/`(세일링스톤)는 이 문서의 SUIT·slate/teal
> 시스템을, `docs-sovereigns/`(소버린즈)는 [SOVEREIGNS-DESIGN.md](SOVEREIGNS-DESIGN.md)를 따릅니다.
